...
class TestConfiguration(TestSuite):
    ...
    def _check_default_values(self, config):
        ...
        self.fail_if(config.get_process_steps() != [],
                     "The default process steps list is incorrect")
        self.fail_if(config.get_filename() != "<new configuration>",
                     "The default filename is incorrect")
    ...
    def test_load_empty_file(self):
        ...
        try:
            ...
            self.fail_if(f"Error reading file: {self._filename}" not in str(e),
    ...
    def test_add_update_instrument(self):
        ...
        self.log.debug(f"Instrument has ID: {instrument_id}")
        ...
        self.fail_if(instrument[conf.KEY_SETTINGS][
                         conf.KEY_INSTRUMENT_SETTINGS]["ip_port"] != 18000,
